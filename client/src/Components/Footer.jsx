      ...
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-blue-500 pb-10">
        <div className="md:max-w-96">
          ...
          <p className="mt-6 text-sm">
            A modern and convenient platform designed to make hotel bookings
            easier. Discover comfortable stays, compare options, and reserve
            your room in just a few clicks anytime, anywhere.
          </p>
        </div>
