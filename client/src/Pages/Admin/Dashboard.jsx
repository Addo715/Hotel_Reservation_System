...
const Dashboard = () => {
    ...
    useEffect(() => {
                ...
                try {
                    ...
                    setStats({
                        ...
                        revenue_per_room_type: revenuePerRoomType.length > 0
                            ? revenuePerRoomType
                            : statsRes.data.revenue_per_room_type
                    });
        ...
        // Poll for localStorage changes every 2 seconds
    ...
    if (loading) return <div className="p-8 text-center text-gray-600 text-lg font-medium">Loading dashboard...</div>;
    if (!stats) return <div className="p-8 text-center text-red-600 text-lg font-medium">Failed to load dashboard data.</div>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-4xl font-bold text-blue-500 mb-2">{stats.total_reservations}</h3>
                            <p className="text-gray-600 font-medium">Total Bookings</p>
                        </div>
                        <div className="bg-teal-50 p-3 rounded-full"><Users className="text-blue-500" size={28} /></div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-4xl font-bold text-blue-500 mb-2">₵{stats.total_payments}</h3> 
  ...
  ₵
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-4xl font-bold text-blue-500 mb-2">{availableRoomsCount}</h3>
                            <p className="text-gray-600 font-medium">Available Rooms</p>
                        </div>
                        <div className="bg-teal-50 p-3 rounded-full"><Home className="text-blue-500" size={28} /></div>
                    </div>
                </div>
            </div>
                        ...
                        <table className="w-full">
                            ...
                            {localBookings.map((booking, index) => (
                                <tr key={index} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm font-semibold text-gray-800"> ₵{booking.total}</td>
